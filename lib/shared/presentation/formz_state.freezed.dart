...
/// @nodoc
class _$FormzStateCopyWithImpl<T, $Res, $Val extends FormzState<T>>
    implements $FormzStateCopyWith<T, $Res> {
...
abstract class Initial<T> implements FormzState<T> {
...
abstract class Loading<T> implements FormzState<T> {
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'FormzState<$T>.failure(exception: $exception)';
  }
...
abstract class Failure<T> implements FormzState<T> {
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'FormzState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements FormzState<T> {
