...
class Spacing {
  ...
  static Widget sizedBoxH_48() => const SizedBox(height: 48);
  static Widget sizedBoxH_50() => const SizedBox(height: 50);
  static Widget sizedBoxH_60() => const SizedBox(height: 60);
  static Widget sizedBoxH_75() => const SizedBox(height: 75);
  static Widget sizedBoxH_150() => const SizedBox(height: 150);
  ...
  static Widget sizedBoxW_32() => const SizedBox(width: 32);
  static Widget sizedBoxW_40() => const SizedBox(width: 40);
}
